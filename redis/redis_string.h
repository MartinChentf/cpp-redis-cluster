...
public:
    /**
     * 返回key所关联的字符串的值
     * @param key {std::string} 字符串对象的key
     ...
     * @param key {std::string} 字符串对象的key
     * @param value {std::string} key所关联的字符串新值
     ...
     * @param key {std::string} 字符串对象的key
     * @param value {std::string} key所关联的字符串值
     ...
     * @param key {std::string} 字符串对象的key
     * @param second {long long} 超时时间, 单位:秒
     * @param value {std::string} key所关联的字符串值
     * @return {bool} 操作是否成功, 返回false表示出错
     */
     ...
     * @param key {std::string} 字符串对象的key
     * @param second {long long} 超时时间, 单位:毫秒
     * @param value {std::string} key所关联的字符串值
     * @return {bool} 操作是否成功, 返回false表示出错
     */
     ...
     * @param key {std::string} 字符串对象的key
     * @param start {int} 子串起始位移
     * @param end {int} 子串末尾位移
     ...
     * @param key {std::string} 字符串对象的key
     * @param offset {int} 指定偏移量的起始位置, 如果偏移量大于字符串长度,
     *  超出部分用0填充
     * @param value {std::string} 覆盖的值
